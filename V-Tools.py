...
def loginSC():
	os.system('clear')
	jalan("\033[1;96mSilahkan login SC nya dulu....:JIKA AKUN FB KALIAN TIDAK INGIN KENA CP SEBELUM LOGIN DI TERMUX LOGIN DLU DI OPERA MINI/BUAT FB BARU.NGERTI LU BANGSAT SUBSCRIBE CHANEL GW..! \n")
